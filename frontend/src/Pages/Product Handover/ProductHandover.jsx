...
const ProductHandover = ({ isSidebarOpen }) => {
    ...
    const AllItems = async () => {
        const response = await fetch("https://spidey-api-seven.vercel.app/getHandoverItems");
        if (!response) {
            alert('server error')
        }
        const data = await response.json();
    ...
    const uploadItems = async (e) => {
        ...
        try {
            const response = await fetch("https://spidey-api-seven.vercel.app/producthandover", {
                method: 'POST',
        ...
        <div className={`${isSidebarOpen ? "ml-16 w-[96%]" : "ml-64 w-[83%]"} transition-all border rounded-lg bg-white h-[650px] p-4 shadow-xl  overflow-y-auto`}>
            <div className="mt-1">
                ...
                >
                    ...
                    <div className="mt-6 w-[70%] mx-auto justify-center text-center">
                        ...
                        <select
                            ...
                            className="border border-gray-400 p-2 rounded w-[50%]"
                        >
